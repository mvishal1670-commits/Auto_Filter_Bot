...
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1003205032844'))  # Premg ium logs channel id
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1003667555937')  # Request channel id (make sure bot is admin)
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/')  # Support group link (make sure bot is admin)

# FORCE_SUB 
auth_req_channels = environ.get("huff", "-1002756876339")# requst to join Channel for force sub (make sure bot is admin) only for bot ADMINS  
...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/ipopcon_bot') # Group link for the bot
